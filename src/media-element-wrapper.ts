...
export class MediaElementWrapperImpl implements MediaElementWrapper {
  ...
  private setupEventListeners(): void {
    ...
    this.element.addEventListener('play', () => this.handleStateChange(MediaState.PLAYING));
    this.element.addEventListener('pause', () => this.handleStateChange(MediaState.PAUSED));
    this.element.addEventListener('ended', () => this.handleStateChange(MediaState.ENDED));
