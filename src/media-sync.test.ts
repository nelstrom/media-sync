...
describe('MediaSync', () => {
  ...
  // Test that the play method gets called on the MediaSync element
  it('should call play() when a programmatic play event is triggered', () => {
    ...
    const playSpy = vi.spyOn(mediaSyncElement, 'play').mockImplementation(() => Promise.resolve());
  ...
  // Test that the pause method gets called on the MediaSync element
  it('should call pause() when a programmatic pause event is triggered', () => {
    ...
    const pauseSpy = vi.spyOn(mediaSyncElement, 'pause').mockImplementation(() => {});
  ...
  // Test that play is called on media elements
  ...
  // Test that pause is called on media elements
  ...
  // Test that user events trigger sync
